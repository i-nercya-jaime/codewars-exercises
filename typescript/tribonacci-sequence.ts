/*
It works basically like a Fibonacci, but summing the last 3 (instead of 2) numbers 
...
Fibonacci sequence by once place, you may be tempted to think that we would get the same sequence shifted by 2 places, but 
...
function tribonacci(signature: [number, number, number], n: number): number[]{
